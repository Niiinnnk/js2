...
<body>
	...
	<main class="container-fluid p-0">
		<div class="prod-main">
			<div class="prod-images" id="3" onclick="productNum(this.id)">
				<div class="img-menu">
					<div class="img-div this-img">
						<button id="0" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_3/image_1.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="1" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_3/image_2.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="2" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_3/image_3.svg" alt=""></button>
					</div>					
				</div>
				<div class="main-img">
					<img id="img" src="../Images/img-pages/product_3/image_1.svg" alt="">
				</div>
			</div>
			<div class="about-prod">
				<div>
					<h2>Смартфон Xiaomi Redmi 9A C3L 32GB</h2>
				</div>
				<div>
					<div class="rating">
		...
		<div class="container-fluid p-0 character-prod">
				...
				<div style="display: flex; width: 100%; flex-direction: column; align-items: center;">
					...
					<div class="det_specifications">
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">Xiaomi Redmi 9A</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">голубой</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">2 SIM</div>
						</div>
						<p>Экран</p>
						<div class="det_specifications_name">
							<div class="det_specifications_value">Диагональ экрана (дюйм) </div>
							<div class="det_specifications_value">6.53"</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Разрешение экрана </div>
							<div class="det_specifications_value">1600х720</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">Android 10</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">2 Гб</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Объем встроенной памяти </div>
							<div class="det_specifications_value">32 ГБ</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Слот для карты памяти</div>
							<div class="det_specifications_value">есть (отдельный слот)</div>
						</div>
						...
						<div class="det_specifications_name">		
							...
							<div class="det_specifications_value">4 (802.11n)</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">77.07 мм</div>
						</div>
						<div class="det_specifications_name">							
							<div class="det_specifications_value">Высота</div>
							<div class="det_specifications_value">164.9 мм</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Толщина</div>
							<div class="det_specifications_value">9 мм</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Вес</div>
							<div class="det_specifications_value">196 г</div>
						</div>
					</div>
				</div>	
			...
			<div class="description" style="margin-left: 10px;">
				...
				<p>
					Redmi 9A получил дисплей с диагональю 6,53 дюйма, HD-разрешением и небольшими рамками. 
					Смартфон оснащен основной камерой на 13 Мп и фронтальной на 5 Мп. 
					Работает смартфон на процессоре MediaTek Helio G25 с 2 ГБ оперативной и 32 ГБ постоянной памяти, есть слот для microSD. 
					Главным преимуществом Redmi 9A стал аккумулятор на 5000 мАч, которого хватает на несколько дней работы.
				</p>					
			</div>	
