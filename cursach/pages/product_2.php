...
<body>
	...
	<main class="container-fluid p-0">
		<div class="prod-main">
			<div class="prod-images" id="2" onclick="productNum(this.id)">
				<div class="img-menu">
					<div class="img-div this-img">
						<button id="0" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_2/image_1.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="1" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_2/image_2.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="2" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_2/image_3.svg" alt=""></button>
					</div>					
				</div>
				<div class="main-img">
					<img id="img" src="../Images/img-pages/product_2/image_1.svg" alt="">
				</div>
			</div>
			<div class="about-prod">
				<div>
					<h2>Смартфон Samsung Galaxy S22 Ultra 256GB</h2>
				</div>
				<div>
					<div class="rating">
		...
		<div class="container-fluid p-0 character-prod">
				...
				<div style="display: flex; width: 100%; flex-direction: column; align-items: center;">
					...
					<div class="det_specifications">
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">Samsung Galaxy S22 Ultra</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Код производителя</div>
							<div class="det_specifications_value">[SM-S908BZKGSKZ]</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">6.8"</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Разрешение экрана </div>
							<div class="det_specifications_value">3088х1440</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Технология изготовления экрана</div>
							<div class="det_specifications_value">Dynamic AMOLED 2X</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Частота обновления экрана</div>
							<div class="det_specifications_value">120 Гц</div>
						</div>
						<p>Система</p>
						<div class="det_specifications_name">
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">12 Гб</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">77.9 мм</div>
						</div>
						<div class="det_specifications_name">							
							<div class="det_specifications_value">Высота</div>
							<div class="det_specifications_value">163.3 мм</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">228 г</div>
						</div>
					</div>
				</div>	
			...
			<div class="description" style="margin-left: 10px;">
				...
				<p>
					Samsung Galaxy S22 Ultra получил 6.8-дюймовый AMOLED-дисплей, выполненный по технологии LTPO с разрешением QHD+ и частотой обновления от 1 до 120 Гц. 
					Объем ОЗУ составляет 12 ГБ, емкость накопителя 256 ГБ. Внутри находится батарея на 5000 мА*ч. Мощность быстрой зарядки равна 45 Вт. 
					У смартфона тыльная камера на 108, 12, 10 и 10 Мп. 
					Селфи-камера на 40 Мп. Работает смартфон под управлением Android 12 с фирменной оболочкой One UI 4.0.
				</p>	
			</div>
