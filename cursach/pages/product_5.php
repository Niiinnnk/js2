...
<body>
	...
	<main class="container-fluid p-0">
		<div class="prod-main">
			<div class="prod-images" id="5" onclick="productNum(this.id)">
				<div class="img-menu">
					<div class="img-div this-img">
						<button id="0" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_5/image_1.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="1" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_5/image_2.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="2" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_5/image_3.svg" alt=""></button>
					</div>					
				</div>
				<div class="main-img">
					<img id="img" src="../Images/img-pages/product_5/image_1.svg" alt="">
				</div>
			</div>
			<div class="about-prod">
				<div>
					<h2>Смартфон HUAWEI P50 256 ГБ</h2>
				</div>
				<div>
					<div class="rating">
		...
		<div class="container-fluid p-0 character-prod">
				...
				<div style="display: flex; width: 100%; flex-direction: column; align-items: center;">
					...
					<div class="det_specifications">
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">HUAWEI P50</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Код производителя</div>
							<div class="det_specifications_value">[51097ALE]</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Год релиза</div>
							<div class="det_specifications_value">2021</div>
						</div>
						<p>Внешний вид</p>
						<div class="det_specifications_name">
							<div class="det_specifications_value">Цвет задней панели</div>
							<div class="det_specifications_value">золотистый</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">2700x1224</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">90 Гц</div>
						</div>
						<p>Система</p>
						<div class="det_specifications_name">
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">Android 11</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">8 Гб</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">есть (универсальный слот SIM + SIM / SIM + карта памяти)</div>
						</div>
						<p>Основная (тыловая) камера</p>
						<div class="det_specifications_name">
							<div class="det_specifications_value">Количество основных (тыловых) камер</div>
							<div class="det_specifications_value">3</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Количество мегапикселей основной камеры</div>
							<div class="det_specifications_value">50+13+12 Мп</div>
						</div>
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">73.8 мм</div>
						</div>
						<div class="det_specifications_name">							
							<div class="det_specifications_value">Высота</div>
							<div class="det_specifications_value">156.5 мм</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Толщина</div>
							<div class="det_specifications_value">7.9 мм</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Вес</div>
							<div class="det_specifications_value">181 г</div>
						</div>
					</div>
				</div>	
			...
			<div class="description" style="margin-left: 10px;">
				...
				<p>
				Huawei P50 оснащен 6.5-дюймовым OLED-дисплеем с разрешением 2700x1224 точек и частотой обновления до 90 Гц. 
				Установлен чип Snapdragon 888, искусственно лишенный поддержки 5G.
                В тыльной части корпуса располагается тройная камера, созданная в партнерстве с Leica: она содержит датчики на 50, 13 и 12 млн пикселей.
				Батарея емкостью 4100 мА·ч поддерживает 66-ватную подзарядку SuperCharge.
				</p>	
			</div>
