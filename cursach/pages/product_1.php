...
<head>
	...
	<title>Apple iPhone XS 256GB</title>
...
<body>
	...
	<main class="container-fluid p-0">
		<div class="prod-main">
			<div class="prod-images" id="1" onclick="productNum(this.id)">
				<div class="img-menu">
					<div class="img-div this-img">
						<button id="0" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_1/image_1.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="1" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_1/image_2.svg" alt=""></button>
					</div>
					<div class="img-div">
						<button id="2" onclick="imgClick(this.id)"><img  src="../Images/img-pages/product_1/image_3.svg" alt=""></button>
					</div>					
				</div>
				<div class="main-img">
					<img id="img" src="../Images/img-pages/product_1/image_1.svg" alt="">
				</div>
			</div>
			<div class="about-prod">
				<div>
					<h2>Смартфон Apple iPhone XS Max 256GB</h2>
				</div>
				<div>
					<div class="rating">
		...
		<div class="container-fluid p-0 character-prod">
				...
				<div style="display: flex; width: 100%; flex-direction: column; align-items: center;">
					...
					<div class="det_specifications">
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">Apple iPhone Xs Max "Как новый"</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Код производителя</div>
							<div class="det_specifications_value">[FT542RU/A]</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Год релиза</div>
							<div class="det_specifications_value">2018</div>
						</div>
						<p>Внешний вид</p>
						<div class="det_specifications_name">
							<div class="det_specifications_value">Цвет задней панели</div>
							<div class="det_specifications_value">серебристый</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">6.5"</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Разрешение экрана </div>
							<div class="det_specifications_value">2688x1242</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">iOS 12</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">4 Гб</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Объем встроенной памяти </div>
							<div class="det_specifications_value">256 ГБ</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">	
							...
							<div class="det_specifications_value">12+12 Мп</div>
						</div>
						<p>Видеосъемка (основная камера)</p>
						<div class="det_specifications_name">
							<div class="det_specifications_value">Формат видеосъемки </div>
							<div class="det_specifications_value">HD, Full HD, Ultra HD 4K</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Разрешение видео и частота кадров</div>
							<div class="det_specifications_value">1280x720 (30 кадр./сек.), 3840x2160 (60 кадр./сек.), 1920x1080 (60 кадр./сек.)</div>
						</div>
						...
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Разрешение видеосъемки</div>
							<div class="det_specifications_value">1920x1080</div>
						</div>
						<p>Коммуникации</p>
						<div class="det_specifications_name">
						...
						<div class="det_specifications_name">		
							...
							<div class="det_specifications_value">5 (802.11ac)</div>
						</div>
						<div class="det_specifications_name">	
						...
						<div class="det_specifications_name">
							...
							<div class="det_specifications_value">77.4 мм</div>
						</div>
						<div class="det_specifications_name">							
							<div class="det_specifications_value">Высота</div>
							<div class="det_specifications_value">157.5 мм</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Толщина</div>
							<div class="det_specifications_value">7.7 мм</div>
						</div>
						<div class="det_specifications_name">	
							<div class="det_specifications_value">Вес</div>
							<div class="det_specifications_value">208 г</div>
						</div>
					</div>
			...
			<div class="description" style="margin-left: 10px;">
				...
				<p>
					Смартфон Apple iPhone Xr выполнен в оригинальной красной расцветке и воплощает в себе технологичность премиального уровня. 
					Аппаратная платформа во главе с процессором A12 Bionic, работающим совместно с Neural Engine и 3 ГБ памяти ОЗУ обеспечивает высокие значения производительности. 
					Память объемом 128 ГБ дает возможность хранить фотографии, видео, приложения, игры и прочий контент в большом количестве.
				</p>	
				<p>
					В смартфоне установлен дисплей 6.1 дюйма на матрице типа IPS (1792x828 пикселей), который формирует реалистичную картинку с насыщенными глубокими цветами. 
					Основная камера 12 Мп с 6-линзовым объективом обеспечивает получение детализированных фото и видеороликов в различных условиях. 
					А для селфи предлагается камера с разрешением 7 Мп и поддержкой ряда режимов. 
					Беспроводные коммуникационные возможности устройства представлены стандартами Wi-Fi 6, Bluetooth, GPS, NFC с поддержкой бесконтактной оплаты Apple Pay. 
					Аккумулятор, емкость которого составляет 2942 мА*ч, способен обеспечить продолжительную автономную работу смартфона Apple iPhone Xr.
				</p>
			</div>
